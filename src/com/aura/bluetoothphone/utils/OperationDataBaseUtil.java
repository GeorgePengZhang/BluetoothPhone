...
import com.aura.bluetoothphone.interf.OnTransaction;
...
public class OperationDataBaseUtil extends SQLiteOpenHelper {
	 ...
	 * @updateInfo 根据传入的needClose判断是否关闭当前的数据库连接.
	 */
	public boolean updateByEncrypt(boolean needClose, String table, String[] titles, String[] values, String conditions, String[] whereValues, String key,
			boolean whereValuesNeedEncrypt) {
		if (titles.length != values.length)
			return false;
		else {
			if (null == db || db.isReadOnly()) {
	 ...
	 */
	public ArrayList<HashMap<String, String>> select(boolean needClose, String table, String[] columns, String selection, String[] selectionArgs, String groupBy,
	 ...
	 * @updateInfo 根据传入的needClose判断是否关闭当前的数据库连接.将游标中的数据遍历返回.
	 */
	public ArrayList<HashMap<String, String>> selectByEncrypt(boolean needClose, String table, String[] columns, String selection, String[] selectionArgs, String groupBy,
			String having, String orderBy, String limit, String key, boolean whereValuesNeedEncrypt) {
		String[] args;
		if (whereValuesNeedEncrypt) {
